  ...
  return (
    <div className="h-full flex flex-col bg-gradient-to-b from-background to-muted/20 relative">
      ...
      <Button
        size="lg"
        onClick={() => setIsNewChatDialogOpen(true)}
        className="fixed top-6 right-6 h-14 w-14 rounded-full shadow-lg hover:shadow-xl bg-gradient-to-r from-primary to-primary/80 hover:from-primary/90 hover:to-primary/70 transition-all duration-300 z-50"
      >
