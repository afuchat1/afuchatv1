...
>(({ className, ...props }, ref) => (
  <SheetPrimitive.Overlay
    className={cn(
      "fixed inset-0 z-40 bg-black/50 backdrop-blur-sm data-[state=open]:animate-in data-[state=closed]:animate-out data-[state=closed]:fade-out-0 data-[state=open]:fade-in-0 transition-all duration-300",
      className,
    )}
    {...props}
    ref={ref}
...
const sheetVariants = cva(
  "fixed z-[60] gap-4 bg-card shadow-soft-xl transition-all ease-premium flex flex-col data-[state=open]:animate-in data-[state=closed]:animate-out",
  {
    variants: {
      side: {
